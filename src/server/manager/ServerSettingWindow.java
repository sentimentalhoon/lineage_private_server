		...
		btn_ok.addMouseListener(new java.awt.event.MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				try {
					...
					//eva.jSystemLogWindow.append("악세인챈 : " + Config.ENCHANT_CHANCE_ACCESSORY + "\n", "Blue");
					...
					eva.jSystemLogWindow.append("깃털지급시간 : " + Config.FEATHER_TIME + "\n", "Blue");
					eva.jSystemLogWindow.append("깃털지급수 : " + Config.FEATHER_NUMBER + "\n", "Blue");
