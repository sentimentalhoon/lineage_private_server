...
import server.threads.world.LineageDecoderThread;
...
public class DecoderManager {
	...
	public synchronized void putClient(LineageClient lc , int ix){
		dts[ix].putClient(lc);
	}
	
	public synchronized void removeClient(LineageClient lc, int ix){
