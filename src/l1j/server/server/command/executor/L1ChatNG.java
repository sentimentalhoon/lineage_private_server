	...
	public void execute(L1PcInstance pc, String cmdName, String arg) {
		try {
			...
			if (tg != null) {
				...
				//pc.sendPackets(new S_ServerMessage(287, name + "의 채팅을 " + String.valueOf(time) + "분간 금지시켰습니다.")); // %0의 채팅을 금지했습니다.
				//pc.sendPackets(new S_ServerMessage(287, name + "의 채팅을 " + String.valueOf(time) + "분간 금지시켰습니다.")); // %0의 채팅을 금지했습니다.
				L1World.getInstance().broadcastServerMessage("\\fY메티스님이 "+name+"\\fY의 부적절한 행동으로 채금을드렸습니다.");
