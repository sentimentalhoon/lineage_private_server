...
public class S_EnchantRanking extends ServerBasePacket {
	...
	private void buildPacket(L1PcInstance pc, int number) {
		...
		if(number == 1) { //추가부분입니다
			...
			writeS("\n\r" + castlename[0] + " " + clanname[0] + " 혈맹 \n\r" + leadername[0]+ " 성주 " + taxrate[0] + "% 세율 \n\r" + "누적 아데나 : " + castleaden[0] +"원 \n\r\n\r" +
					castlename[1] + " " + clanname[1] + " 혈맹 \n\r" + leadername[1] + " 성주 " + taxrate[1] + "% 세율 \n\r" + "누적 아데나 : " + castleaden[1] + "원 \n\r\n\r" +
					castlename[2] + " " + clanname[2] + " 혈맹 \n\r" + leadername[2] + " 성주 " + taxrate[2] + "% 세율 \n\r" + "누적 아데나 : " + castleaden[2] + "원 \n\r\n\r" +
					castlename[3] + " " + clanname[3] + " 혈맹 \n\r" + leadername[3] + " 성주 " + taxrate[3] + "% 세율 \n\r" + "누적 아데나 : " + castleaden[3] + "원 \n\r\n\r" +
					"      ");
