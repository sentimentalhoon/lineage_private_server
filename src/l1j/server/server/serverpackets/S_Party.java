...
public class S_Party extends ServerBasePacket {
	...
	packetbox :119 길이 :48
	================================================================================
	77 68 01 (옵/타입/사람수-초대파티원제외한사람수) 
	e4 eb 26 0f / 45 76 61 74 65 73 74 00 / 64 / 44 00 00 00 / 1a 80 / ef 7f (obj/name/게이지/map/x/y)
	b4 45 26 0f / 45 76 61 74 65 73 74 31 31 00 / 64 / 44 00 00 00 / 19 80 / ef 7f (obj/name/게이지/map/x/y)
	3c*/
