...
public class C_SoldierGiveOK extends ClientBasePacket {
	...
	public C_SoldierGiveOK(byte abyte0[], LineageClient clientthread) {
		...
		if (pc.getClanid() != target.getClanid()) return;
		...
		switch (index) {
		case 1: soldier.setSoldier1(sum); break;
		case 2: soldier.setSoldier2(sum); break;
		case 3: soldier.setSoldier3(sum); break;
		case 4: soldier.setSoldier4(sum); break;
		default: break; }
