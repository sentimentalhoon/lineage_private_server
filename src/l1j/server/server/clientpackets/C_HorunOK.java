...
public class C_HorunOK extends ClientBasePacket {
	...
	public C_HorunOK(byte abyte0[], LineageClient clientthread)
		...
		int skill_id = 0;
		/*
		<p>1레벨 마법을 배우는 것이라면 <font fg=ffffaf>아라크네의 거미줄 10타래</font>나 <font fg=ffffaf>미스릴 50개</font>, <font fg=ffffaf>페어리 더스트 100개</font>, <font fg=ffffaf>판의 갈기털 10뭉치</font> 중 한종류만 가져다 주시면 되요.</p>
		<p>2레벨 마법을 배우는 것이라면 <font fg=ffffaf>미스릴 실 10개</font>나 <font fg=ffffaf>버섯 포자의 즙 8개</font>, <font fg=ffffaf>판의 뿔 1개</font>, <font fg=ffffaf>엔트의 껍질 3개</font> 중 한종류만 가져다 주시면 되고요.</p>
		<p>3레벨 마법을 배우는 것이라면 <font fg=ffffaf>오리하루콘 45개</font>나 <font fg=ffffaf>아라크네의 허물 3개</font>, <font fg=ffffaf>페어리의 날개 3개</font>, <font fg=ffffaf>판의 뿔 3개</font> 중 한종류만 가져다 주시면 되지요.</p>
		*/
		...
		for (int i = 0; i < count; i++) {
			...
			case 0:
				...
				if(level1_cost == 0 && level1_cost2 == 0 && level1_cost3 == 0 && level1_cost4 == 0){
