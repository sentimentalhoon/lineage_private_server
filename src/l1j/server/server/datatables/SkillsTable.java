...
public class SkillsTable {
	...
	private void FillSkillsTable(ResultSet rs) throws SQLException {
		...
		while (rs.next()) {
			...
			l1skills.setcanCastWithInvis(rs.getBoolean("can_cast_with_invis")); 
			l1skills.setignoresCounterMagic(rs.getBoolean("ignores_counter_magic"));
	...
	public L1Skills getTemplate(int skillId) {
