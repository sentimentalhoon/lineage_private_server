	...
	private Dungeon() {
		...
		try {
			...
			while (rs.next()) {
				...
				if ((srcX >= 33423 && srcX <= 33426) && srcY == 33502 && srcMapId == 4 // Heine선착장->FI행의 배
						|| (srcX >= 32733 && srcX <= 32736) && srcY == 32794 && srcMapId == 83) { // FI행의 배->Heine선착장
					dungeonType = DungeonType.SHIP_FOR_FI;
				} else if ((srcX >= 32935 && srcX <= 32937) && srcY == 33058 && srcMapId == 70 // FI선착장->Heine행의 배
						|| (srcX >= 32732 && srcX <= 32735) && srcY == 32796 && srcMapId == 84) { // Heine행의 배->FI선착장
					dungeonType = DungeonType.SHIP_FOR_HEINE;
				} else if ((srcX >= 32750 && srcX <= 32752) && srcY == 32874 && srcMapId == 445 // 숨겨진 선착장->해적섬행의 배
						|| (srcX >= 32731 && srcX <= 32733) && srcY == 32796 && srcMapId == 447) { // 해적섬행의 배->숨겨진 선착장
					dungeonType = DungeonType.SHIP_FOR_PI;
				} else if ((srcX >= 32296 && srcX <= 32298) && srcY == 33087 && srcMapId == 440 // 해적도선착장->숨겨진 선착장행의 배
						|| (srcX >= 32735 && srcX <= 32737) && srcY == 32794 && srcMapId == 446) { // 숨겨진 선착장행의 배->해적도선착장
				...
				if (_dungeonMap.containsKey(key)) {
					_log.log(Level.WARNING,
							"같은 키의 dungeon 데이터가 있습니다. key=" + key);
				}
