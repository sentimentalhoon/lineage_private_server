...
public class L1UltimateBattle {
	...
	private void spawnSupplies(int curRound) {
		...
		case 2:
			if (curRound == 1) {
				spawnGroundItem(L1ItemId.ADENA, 30000, 40);
				spawnGroundItem(40507, 10, 15);  //엔줄
				spawnGroundItem(40087, 1, 10);  //데이
				spawnGroundItem(40024, 10, 20);  //고말
				spawnGroundItem(40317, 2, 5);  //숫돌
				spawnGroundItem(40093, 3, 15); //빈줌4
				spawnGroundItem(41402, 1, 20); // 용자의 표식
				sendMessage("콜롯세움 관리인: 제 1 군의 투입이 완료되었습니다.");
				sendMessage("콜롯세움 관리인: 1분 후에 제 2 군의 투입이 시작됩니다.");
			} else if (curRound == 2) {
				spawnGroundItem(L1ItemId.ADENA, 50000, 40);
				spawnGroundItem(40507, 10, 15);  //엔줄
				spawnGroundItem(40074, 1, 10);  //젤
				spawnGroundItem(40024, 10, 20);  //고말
				spawnGroundItem(40317, 1, 7);  //숫돌
				spawnGroundItem(40093, 3, 10);	//빈줌4	
				spawnGroundItem(40094, 3, 15); //빈줌5
				spawnGroundItem(41402, 1, 30); // 용자의 표식
				...
				spawnGroundItem(140074, 1, 1);  //축젤
				spawnGroundItem(40074, 2, 10);  //젤
				spawnGroundItem(40087, 1, 10);  //데이
				spawnGroundItem(40024, 10, 20);  //고말
				spawnGroundItem(40317, 1, 10);  //숫돌
				spawnGroundItem(140087, 1, 1); //축데이
				spawnGroundItem(40095, 1, 20); //빈줌5
				spawnGroundItem(41402, 1, 40); // 용자의 표식
	...
	class UbThread implements Runnable {
		...
		private void waitForNextRound(int curRound) throws InterruptedException {
			final int WAIT_TIME_TABLE[] = { 7, 12, 6, 30 };
