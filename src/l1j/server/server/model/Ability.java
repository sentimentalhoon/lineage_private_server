...
public class Ability {
	...
	public int getAmount()			{ return str + con + dex + cha + intel + wis; }
	public int getBaseAmount()		{ return baseStr + baseCon + baseDex + baseCha + baseInt + baseWis; }
	
	public byte getStr()			{ return str;					}
	public void setStr(int i)		{ str = checkRange(i, baseStr);	}
	public void addStr(int i)		{ setStr(getStr() + i);			}
	
	public byte getBaseStr() 	  {	return baseStr;					}
	public void addBaseStr(int i) {	setBaseStr(getBaseStr() + i);	}
	...
	public byte getAddedStr()	  { return addedStr; 							}
	public void addAddedStr(int i){ addedStr = checkRange(addedStr + i, LIMIT_MINUS_MIN); }
	public byte getTotalStr()	  { return checkRange(getStr() + getAddedStr());}
	
	public byte getCon() 		  {	return con;						}
	public void setCon(int i) 	  {	con = checkRange(i, baseCon);	}
	public void addCon(int i) 	  {	setCon(getCon() + i);			}
	
	public byte getBaseCon() 	  {	return baseCon;					}
	public void addBaseCon(int i) { setBaseCon(getBaseCon() + i);	}	
	...
	public byte getAddedCon()	  { return addedCon; 							}
	public void addAddedCon(int i){ addedCon = checkRange(addedCon + i, LIMIT_MINUS_MIN); }
	public byte getTotalCon()	  { return checkRange(getCon() + getAddedCon());}

	public byte getDex() 		  {	return dex;						}
	public void setDex(int i) 	  {	dex = checkRange(i, baseDex);	}
	public void addDex(int i) 	  {	setDex(getDex() + i);			}
	
	public byte getBaseDex() 	  {	return baseDex;					}
	public void addBaseDex(int i) {	setBaseDex(getBaseDex() + i);	}
	...
	public byte getAddedDex()	  { return addedDex; 							}
	public void addAddedDex(int i){ addedDex = checkRange(addedDex + i, LIMIT_MINUS_MIN); }
	public byte getTotalDex()	  { return checkRange(getDex() + getAddedDex());}

	public byte getCha() 		  {	return cha;						}
	public void setCha(int i) 	  {	cha = checkRange(i, baseCha);	}
	public void addCha(int i) 	  {	setCha(getCha() + i);			}
	
	public byte getBaseCha()	  {	return baseCha; 				}
	public void addBaseCha(int i) { setBaseCha(getBaseCha() + i); 	}
	...
	public byte getAddedCha()	  { return addedCha; 							}
	public void addAddedCha(int i){ addedCha = checkRange(addedCha + i, LIMIT_MINUS_MIN); }
	public byte getTotalCha()	  { return checkRange(getCha() + getAddedCha());}
	
	public byte getInt() 		  {	return intel;					}
	public void setInt(int i) 	  {	intel = checkRange(i, baseInt);	}
	public void addInt(int i) 	  {	setInt(getInt() + i);			}
	
	public byte getBaseInt() 	  {	return baseInt;					}
	public void addBaseInt(int i) {	setBaseInt(getBaseInt() + i);	}
	...
	public byte getAddedInt()	  { return addedInt; 							}
	public void addAddedInt(int i){ addedInt = checkRange(addedInt + i, LIMIT_MINUS_MIN); }
	public byte getTotalInt()	  { return checkRange(getInt() + getAddedInt());}
	
	public byte getWis() 		  {	return wis;						}
	public void setWis(int i) 	  {	wis = checkRange(i, baseWis);	}
	public void addWis(int i) 	  {	setWis(getWis() + i);			}
	
	public byte getBaseWis() 	  {	return baseWis;					}
	public void addBaseWis(int i) {	setBaseWis(getBaseWis() + i);	}
	...
	public byte getAddedWis()	  { return addedWis; 							}
	public void addAddedWis(int i){ addedWis = checkRange(addedWis + i, LIMIT_MINUS_MIN); }
	public byte getTotalWis()	  { return checkRange(getWis() + getAddedWis());}
	
	public int getElixirCount() 		{ return elixirCount; 	}
	public void setElixirCount(int i) 	{ elixirCount = i;		}
	public int getBonusAbility() 		{ return bonusAbility;	}
	public void setBonusAbility(int i) 	{ bonusAbility = i;		}
	...
	public boolean isNormalAbility(final int classId, final int currentLevel, final int highestLevel, final int total) {
		...
		if(total != minStr+minDex+minCon+minWis+minCha+minInt+remainStats) result = false;
		if(getStr() < minStr || getStr() > MaxAbility) result = false;  
		if(getDex() < minDex || getDex() > MaxAbility) result = false;
		if(getCon() < minCon || getCon() > MaxAbility) result = false;
		if(getWis() < minWis || getWis() > MaxAbility) result = false;
		if(getCha() < minCha || getCha() > MaxAbility) result = false;
		if(getInt() < minInt || getInt() > MaxAbility) result = false;
	...
	public void addSp(int i) 	{ sp += i; }
	public int getSp() 			{ return getTrueSp() + sp; }
	public int getTrueSp() 		{ return getMagicLevel() + getMagicBonus(); }
	...
	public int getMagicBonus() {
		...
		else if (i <= 24) 	return i - 15;
		else if (i <= 35) 	return 10;
		else if (i <= 42) 	return 11;
		else if (i <= 49) 	return 12;
		else if (i <= 50) 	return 13;
		else 				return i - 25;
	}
