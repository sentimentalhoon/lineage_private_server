...
public class Spellbook extends L1ItemInstance{
	...
	public void clickItem(L1Character cha, ClientBasePacket packet){
		if(cha instanceof L1PcInstance){
			...
			if (itemId > 40169 && itemId < 40226 || itemId >= 45000 && itemId <= 45022) { // 마법서
			...
			} else if (itemId > 40225 && itemId < 40232 || itemId == 5000150|| itemId == 5000152) {
				if (pc.isCrown() || pc.isGm()) {
					if (itemId == 40226 && pc.getLevel() >= 15) {
						...
						SpellBook4(pc, useItem);
					} else if (itemId == 5000150 && pc.getLevel() >= 55) {//아바타
						SpellBook4(pc, useItem);
					} else if (itemId == 5000152 && pc.getLevel() >= 55) {//디바인
						SpellBook4(pc, useItem);
				...
				if (pc.isDragonknight() || pc.isGm()) {
					...
					} else if (itemId >= L1ItemId.DRAGONKNIGHTTABLET_BLOODLUST && itemId <= L1ItemId.DRAGONKNIGHTTABLET_AWAKE_PAPURION
							&& pc.getLevel() >= 30) {
						SpellBook5(pc, useItem);
					} else if (itemId >= L1ItemId.DRAGONKNIGHTTABLET_MOTALBODY && itemId <= L1ItemId.DRAGONKNIGHTTABLET_AWAKE_BALAKAS
							&& pc.getLevel() >= 45) {
						SpellBook5(pc, useItem);
					} else {
						pc.sendPackets(new S_ServerMessage(312));
	...
	private void SpellBook(L1PcInstance pc, L1ItemInstance item,
		...
		for (int skillId = 1; skillId < 81; skillId++) {
			...
			if (item.getItem().getName().equalsIgnoreCase(s1)) {
				...
				switch (skillLevel) {
				case 1: level1 = i7; break;
				case 2: level2 = i7; break;
				case 3: l = i7; break;
				case 4: i1 = i7; break;
				case 5: j1 = i7; break;
				case 6: k1 = i7; break;
				...
				case 23: l5 = i7; break;
				case 24: i6 = i7; break;
				case 25: dk3 = i7; break;
				case 26: bw1 = i7; break;
				case 27: bw2 = i7; break;
				case 28: bw3 = i7; break;
				}
			}
		}
