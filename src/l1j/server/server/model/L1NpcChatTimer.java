...
public class L1NpcChatTimer extends TimerTask {
	...
	private void chat(L1NpcInstance npc, int chatTiming, String chatId, 
		...
		if (chatTiming == L1NpcInstance.CHAT_TIMING_APPEARANCE && npc.isDead()) { return; }
		if (chatTiming == L1NpcInstance.CHAT_TIMING_DEAD && !npc.isDead()) { return; }
		if (chatTiming == L1NpcInstance.CHAT_TIMING_HIDE && npc.isDead()) { return; }
