...
import l1j.server.server.serverpackets.S_DoActionShop2;
		...
		public void run() {
			try {
				...
				for(int i = 0; i < list.size(); i++){
					...
					obj.setState(1);
					Broadcaster.broadcastPacket(npc, new S_DoActionShop2(npc.getId(), ActionCodes.ACTION_Shop, shop.getShopName().getBytes()));
