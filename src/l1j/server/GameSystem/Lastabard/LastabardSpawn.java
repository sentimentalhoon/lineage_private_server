...
public class LastabardSpawn extends L1Spawn {
	...
	public LastabardSpawn(L1Npc mobTemplate) throws SecurityException, ClassNotFoundException {
		super(mobTemplate);
	...
	protected void doSpawn(int spawnNumber, int objectId) {
		...
		try {
			if (objectId == 0) 	mob.setId(ObjectIdFactory.getInstance().nextId());
			else 				mob.setId(objectId);
			
			int heading = getHeading();
			if (0 > heading || heading > 7) heading = 5;
			...
			while (tryCount <= 50) {
				...
				if (mob.getMap().isInMap(mob.getLocation()) && mob.getMap().isPassable(mob.getLocation())) {
					if (L1World.getInstance().getVisiblePlayer(mob).size() == 0 || isRespawnScreen())
						break;
			...
			if(LastabardData.isFourthFloor(getMapId())) 
				LastabardController.getInstance().alive(getMapId(), LastabardData.getPos(getMapId(), getLocX(), getLocY()));

			if (mob.getHiddenStatus() == 0) mob.onNpcAI();
			
			if (getGroupId() != 0) {
				L1MobGroupSpawn.getInstance().doSpawn(mob, getGroupId(),isRespawnScreen(), true);
			}
			mob.setDeath(new LastabardDead(mob, getLocX(), getLocY(), getDoorId(), getCountMapId()));
	...
	public void setMapId(short id) { mapid = id;   }
	...
	public int getLocX1() { return locx1; }
	public int getLocY1() { return locy1; }
 	public int getLocX2() { return locx2; }
	public int getLocY2() { return locy2; }
	
	public void setLocX(int x)  { locx = x;  }
	public void setLocY(int y)  { locy = y;  }
	public void setLocX1(int x) { locx1 = x; }
	public void setLocY1(int y) { locy1 = y; }
	public void setLocX2(int x) { locx2 = x; }
	public void setLocY2(int y) { locy2 = y; }
	
	public int getHeading() { return heading; }
	public int getRandomx() { return randomx; }
	public int getRandomy() { return randomy; }
	
	public void setHeading(int h)  { heading = h;  }
	public void setRandomx(int rx) { randomx = rx; }
	public void setRandomy(int ry) { randomy = ry; }
	
	public void setRest(boolean flag) 	{ rest = flag; }
	public boolean isRest() 			{ return rest; }
	
	public String getLocation() 		{ return location; }
	public void setLocation(String loc) { location = loc;  }
	
	public int getMinRespawnDelay() { return minRespawnDelay; }
	public int getMaxRespawnDelay() { return maxRespawnDelay; }
	
	public int getAmount() 			  { return maximumCount;    }
	public void setAmount(int amount) { maximumCount = amount;	}
	
	public void setMinRespawnDelay(int i) {	minRespawnDelay = i; }
	public void setMaxRespawnDelay(int i) {	maxRespawnDelay = i; }
	
	public int getMovementDistance() 		{ return movementDistance; 	}
	public void setMovementDistance(int i)	{ movementDistance = i; 	}
	
	public boolean isRespawnScreen()   			{ return respawnScreen; }
	public void setRespawnScreen(boolean flag) 	{ respawnScreen = flag; }
	...
	public void setCountMapId(int countMapId) 	{ this.countMapId = countMapId;	}
	public int getDoorId() 		{ return this.doorId; 	  }
	public int getCountMapId() 	{ return this.countMapId; }
}