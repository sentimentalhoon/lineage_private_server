...
public final class Config {
	...
	//
	public static boolean STANDBY_SERVER = false;//[0062]  // 오픈대기
	//# 자동 공지사항..
	...
	public static final String servername = "칸";
	/** NewClan **/
	...
	public static final String NewClanName1 = "하이네";
	public static final String NewClanName2 = "사이하";
	public static final String NewClanName3 = "오렌";
	public static final String NewClanName4 = "조우";
	...
	public static void load() {
		...
		try {
			...
			RATE_ROBOT_TIME = Integer.parseInt(rateSettings.getProperty("RateRobotTime", "20")); // 무인PC(쿠우)
			...
			NEWUSERSAFETY_LEVEL = Integer.parseInt(rateSettings.getProperty("NewUserSafetyLevel", "12"));// A105 신규 혈맹 보호 레벨 제한
